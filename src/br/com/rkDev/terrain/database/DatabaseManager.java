...
public class DatabaseManager {
	...
	public DatabaseManager() {
		...
		addCommandSetup("CREATE TABLE IF NOT EXISTS `user_terrain` ( `id` INT(30) NULL AUTO_INCREMENT , `user_id` INT(15) NOT NULL , `cuboid` VARCHAR(255) NOT NULL , `spawn` VARCHAR(255) NOT NULL , `sale` TINYINT(1) NOT NULL, PRIMARY KEY (`id`)) ENGINE = InnoDB;");
	}
